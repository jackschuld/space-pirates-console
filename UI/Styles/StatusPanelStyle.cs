...
{
    public class StatusPanelStyle : BaseStyleProvider
    {
        ...
        public static ConsoleColor GetPlanetColor(Planet planet)
        {
            if (planet.Resources != null && planet.Resources.Count > 0)
            {
                ...
                return GetResourceColor(dominant.Resource.Name);
            }
        ...
        public static string GetScientificResourceName(string resourceName)
        {
            resourceName = resourceName.ToLowerInvariant();
