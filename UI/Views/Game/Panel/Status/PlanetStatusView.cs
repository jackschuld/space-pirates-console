    ...
    public class PlanetStatusView : StatusView
    {
        ...
        protected override void RenderDetails(IBufferWriter buffer, int textX, ref int y)
        {
            ...
            if (!_planet.IsDiscovered)
            {
                ...
                buffer.DrawString(textX, y + 4, "Explore this planet to reveal", DiscoveryPanelStyle.HiddenTextColor);
                buffer.DrawString(textX, y + 5, "its details.", DiscoveryPanelStyle.HiddenTextColor);
                return;
            }
