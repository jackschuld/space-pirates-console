...
using SpacePirates.Console.UI.Utils;
...
namespace SpacePirates.Console.UI.Views
{
    public class ShipStatusView : StatusView
    {
        ...
        protected override void RenderDetails(IBufferWriter buffer, int textX, ref int y)
        {
            ...
            string hullBar = SpacePirates.Console.UI.Utils.StatusComponentHelpers.RenderBar(hullPercentage, 12, '■', ' ');
            ...
            if (ship.Shield != null)
            {
                ...
                int barWidth = 12;
                string bar = SpacePirates.Console.UI.Utils.StatusComponentHelpers.RenderBar(ship.Shield.IsActive || ship.Shield.Charging ? shieldPercentage : 0, barWidth, '■', ' ');
            ...
            if (ship.CargoSystem != null)
            {
                ...
                string cargoBar = SpacePirates.Console.UI.Utils.StatusComponentHelpers.RenderBar(cargoPercentage, 12, '■', ' ');
            ...
            if (ship.FuelSystem != null)
            {
                ...
                string fuelBar = SpacePirates.Console.UI.Utils.StatusComponentHelpers.RenderBar(fuelPercentage, 12, '■', ' ');
            ...
            if (ship.WeaponSystem != null)
            {
                ...
                string damageBar = SpacePirates.Console.UI.Utils.StatusComponentHelpers.RenderBar(damagePercent, 12, '■', ' ');
